...
if($usuario == ''){
  echo "<h5>Por favor, digite o seu usuario</h5>";
}else if($senha == ''){
  echo "<h5>Por favor, digite sua senha!</h5>";
}else{
  
$sql_1 = mysqli_query($conecta, "SELECT * FROM acesso_ao_sistema WHERE usuario = '$usuario' AND senha = '$senha'") or die (mysqli_error());
