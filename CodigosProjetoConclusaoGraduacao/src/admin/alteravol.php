          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-5">
                    <h4 class="card-title mb-0"><b> Alterar Voluntario: </b></h4><br>
                            ...
                            ?>          
                      <form action="alteracaovol.php">
                        <input type="hidden" name="id" value="<?php echo $id ?>" />
                         <p> <label for="cName">Nome:</label> 
                               <input type="text" name="vNome" id= "cName" size="80" maxlength="50" value="<?php echo $nome ?>" /></p>
                            
                                <p><label for="cMail">E-mail:</label>
                                 <input type="email" name="vMail" id="cMail" size="80" maxlength="40" value="<?php echo $email ?>" /></p>

                                 <p> <label for="cTelph">Telefone:</label> 
                               <input type="text" name="vTel" id= "cTelph" size="80" maxlength="50" value="<?php echo $tel ?>" /></p>

                               <p> <label for="cBen">Benfeitoria:</label> 
                               <input type="text" name="vBen" id= "cBen" size="80" maxlength="50" value="<?php echo $benf ?>" /></p>

                                <p><label for="cObs"> Observações:</label>
                               <textarea name="vObs" id="vObs" cols="80" rows="8" value="<?php echo $obs ?>"></textarea></p>

                               <button type="buttom" class="btn btn-primary" id="btn_login">OK</button>
