...
<html lang="en">
      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Evasão</a>
            </li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Buscar ponto</a>
            </li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-5">
                    <h4 class="card-title mb-0"><b> ETINERÁRIO: </b></h4><br>
                                 <?php
 ...
 <p> <label for="cName">Pesquisar:</label> 
  <input type="text" name="pesquisar" id= "pesquisar" size="80" maxlength="50" placeholder="Digite o ponto de referência do Atendido"/></p>
<button type="buttom" class="btn btn-primary" id="btn_login">Enviar</button>
</form>
