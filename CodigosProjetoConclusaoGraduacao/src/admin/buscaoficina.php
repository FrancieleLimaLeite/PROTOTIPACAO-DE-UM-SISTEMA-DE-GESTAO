          ...
          <div id="Layer1" style="position:absolute; left:210px; top:70px; width:300; height:90; z-index:0; overflow: auto">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-5">
                    <h4 class="card-title mb-0"><b> OFICINAS CADASTRADAS: </b></h4><br>
                            <form method="post">
                            ...
                            <button type="buttom" class="btn btn-primary" id="btn_login">OK</button></p>
                                   ...
                                   <form action='buscaoficina.php' method='post'>
                                  ...
                                  $filtro_sql= "";
                                   ...
                                   if ($_POST != NULL) {
                                     ...
                                     $filtro_sql = "WHERE id LIKE '%$filtro%'
                                                     or oficina LIKE '%$filtro%'
                                                     or professor LIKE '%$filtro%'
                                                     or turno LIKE '%$filtro%'";
                                   }

                                     if (isset($_POST['del'])) {
                                       foreach ($_POST['del'] as $codigo) {
                                         $sql= "delete from oficinas where id=$codigo";
                                    ...
                                    if ($sql) {
                                      ...
                                      echo "<script>
                                           alert('Oficina não foi ecluído com sucesso!');
                                            </script>";
}
                                       }
                                     } else{
                                  ...
                                  $sql = "SELECT * FROM oficinas $filtro_sql";
