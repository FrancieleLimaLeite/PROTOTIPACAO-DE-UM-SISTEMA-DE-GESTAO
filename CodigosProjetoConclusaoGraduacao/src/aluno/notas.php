      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">Consultar Faltas</li>
            <li class="nav-item">
              <a class="nav-link" href="faltas.php">
                <i class="nav-icon icon-drop"></i> Frequencia nas Oficinas</a>
            </li>
           
            </li>
            <li class="nav-title">Consultar Avaliação</li>
          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-11">
                    <h4 class="card-title mb-0"><b>AVALIAÇÃO DE DESEMPENHO DO ATENDIDO NAS OFICINAS.</h4>
                    <br><br>
                   <h1> AQUI A IDÉIA É APARECER A "NOTA" QUE OS OFICINEIROS DÃO AOS ATENDIDOS  </h1>
